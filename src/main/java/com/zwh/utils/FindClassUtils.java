...
public class FindClassUtils {
    ...
    private static void findClassesInPackageByJar(String packageName, Enumeration<JarEntry> entries,
        ...
        while (entries.hasMoreElements()) {
            //获取jar里的一个实体，可能是目录，类文件，或一些其他文件，如META-INF等文件
            ...
            //如果前半部分和定义的包名相同就处理，否则就不处理了,因为一个Jar包中可能会有多个不同的java包
    ...
    private static void findClassesInPackageByFile(String packageName,
        ...
        File[] dirfiles = dir.listFiles(f -> (recursive && f.isDirectory()) || (f.getName().endsWith(".class")));
        // 循环所有文件
